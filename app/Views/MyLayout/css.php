...
<link rel="stylesheet" type="text/css" href="<?= base_url() ?>/template/css/sb-admin-2.min.css" />
<link rel="stylesheet" type="text/css" href="<?= base_url() ?>/template/sweetalert2/sweetalert2.min.css" />
